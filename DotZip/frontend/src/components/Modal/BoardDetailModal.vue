    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
          ...
          <table class="table table-hover">
            <tbody>
              ...
              <tr>
                ...
                <!-- {{board.boardId}} 로 쓰면 html 태그 다나옴 (CKEditor의 내용은 html 태그로 구성)-->
              </tr>
              <tr>
                <td>작성자</td>
        ...
        <div class="modal-footer" v-show="board.sameUser">
          <button type="button" @click="changeToUpdate" class="btn btn-sm btn-success">수정</button>
          <button id="btnBoardDeleteConfirm" type="button" @click="changeToDelete" class="btn btn-sm btn-warning">
            삭제
          </button>
        </div>
      </div>
